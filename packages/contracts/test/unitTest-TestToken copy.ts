...
describe("TestToken", function () {
    ...
    it("Should return warning upon minting to burn address at 0x0", async function () {
        ...
        await expect(testToken.connect(addr1).mint("0x0000000000000000000000000000000000000000", 100)).to.be.revertedWith('ERC20: mint to the zero addres');
    })
    ...
    it("Should return warning upon buring from address at 0x0", async function () {
        ...
        await expect(testToken.connect(addr1).burn("0x0000000000000000000000000000000000000000", 100)).to.be.revertedWith('ERC20: burn from the zero address');
